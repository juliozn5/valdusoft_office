                    ...
                    <div class="card-body pt-1">
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <fieldset class="form-label-group form-group position-relative has-icon-left">
                                <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Correo Electrónico" value="{{ old('email') }}" autofocus required>
                            ...
                            <div class="form-group d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-right"><a href="auth-forgot-password.html" class="card-link">¿Olvidaste tu contraseña?</a></div>
                            </div>
                            <a href="{{ route('register') }}" class="btn btn-outline-primary float-left btn-inline">Registrar</a>
