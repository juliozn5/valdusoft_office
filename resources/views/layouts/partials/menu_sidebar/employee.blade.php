<li class=" nav-item">
    <a href="{{ route('landing.dashboard') }}"><i class="feather icon-home"></i><span class="menu-title"
            data-i18n="Email">Tablero</span></a>
</li>
...
<li class=" nav-item">
    <a href="{{ route('landing.profile') }}"><i class="feather icon-user"></i><span class="menu-title"
