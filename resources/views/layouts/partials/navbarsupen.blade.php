<nav class="header-navbar navbar-expand-lg navbar navbar-with-menu floating-nav navbar-light navbar-shadow shadow-lg" style="width: 15%; background-color: rgba(255, 255, 255, 0);">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none">
                                ...
                                <span class="user-status text-bold-600 role-color text-white">Suspendido</span>
                                @endif
                            </div>

                            <span>
                                @if (!(Auth::user()->photo))
                                <i class="feather icon-user" style="font-size: 40px; color:antiquewhite;"></i>
                                @else
