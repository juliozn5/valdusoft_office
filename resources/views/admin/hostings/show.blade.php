...
<div class="card-body">
    <div class="card-header">
        ...
        <div>
            <div class="btn btn-hos_show mr-1 center" style="background-color:#FF4D00;color: white;" href="#"><img src="{{asset('images/valdusoft/cpanel-logo.png')}}" width="18px" alt="" style="margin-right:5px;" >Ir al Cpanel</div>
            <div class="btn btn-hos_show mr-1 center" style="background-color: #06B054;color: white;" href="#"><img src="{{asset('images/valdusoft/refresh.png')}}" width="18px" alt="" style="margin-right:5px;">Renovar</div>
