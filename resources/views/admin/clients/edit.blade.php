                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.clients.edit', $client->id) }}">Editar Cliente</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-2">Editando el cliente <span
                                class="text-primary font-weight-bold">{{ $client->name }}</span></h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body px-2">
                            <form class="form form-vertical" action="{{ route('admin.clients.update', $client->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="row justify-content-between">
                                                ...
                                                <div class="col-6">
                                                    <label class="h5" for="due_date">Logo para el Cliente</label>
                                                    <div class="media">
                                                        <div class="custom-file">
                                                            <label class="custom-file-label" for="logo"><b>Logo del Cliente</b></label>
                                                            <input type="file" id="logo"
                                                                class="custom-file-input @error('logo') is-invalid @enderror"
                                                                name="logo"
                                                                onchange="previewFile(this, 'photo_preview2')"
                                                                accept="image/*">
                                                            @error('logo')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
