                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('landing.projects') }}">Project</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route('landing.projects-edit', $projects->id) }}">Editar Project</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" action="{{ route('landing.projects-update', $projects->id) }}" method="POST"
