                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="card-title mb-1">Gregorio Zambrano</h3>
                            <p>gregorio_zambrano@gmail.com</p>
                        </div>
                    </div>
                </div>
<div class="card-body">
...
<div class="mt-3">
    <div class="project-detail-titles"><strong>Curriculum Vitae<strong></div>
        <div class="mt-1">
            <div class="col-md-4 ml-2 position-absolute"><span>CV_Gregorio_Zambrano.pdf</span></div>
        </div>
    ...
    <div class="row">
        <div class="col-md-3 col-sm-1">
            <div class="project-detail-titles"><strong>Precio Por Hora</strong></div>
                <div class="mt-1 project-detail-dates">
                    <img src="{{ asset('images/icons/dollar.png')}}" alt="" class="mr-1"><span>4 USD</span>
                </div>
            </div>
        <div class="col-md-5 col-sm-1">
            <div class="project-detail-titles"><strong>Billetera USDT Red tron<strong></div>            
                <div class="mt-1 project-detail-dates">
                    <img src="{{ asset('images/icons/uphold.png')}}" alt="" class="mr-1"><span>Gregorio_Zambrano@gmail.com</span>
                </div>
        </div>
    </div>
</div>
